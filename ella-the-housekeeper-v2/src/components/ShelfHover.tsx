...
export default function ShelfHover({
  content,
}: {
    ...
    <NavigationMenuItem>
      ...
      <NavigationMenuContent>
        <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
          ...
          <ListItem
            href="/food-supplies"
            title={content.navegationDescriptions.shelfTitles[0]}
            className=""
          ...
          <ListItem
            ...
            title={content.navegationDescriptions.shelfTitles[1]}
            className=""
          ...
          <ListItem
            ...
            title={content.navegationDescriptions.shelfTitles[2]}
            className=""
